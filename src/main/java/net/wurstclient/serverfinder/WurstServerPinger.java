...
public class WurstServerPinger
	implements IServerFinderDisconnectListener, IServerFinderDoneListener
{
	...
	private ArrayList<IServerFinderDoneListener> doneListeners =
		new ArrayList<>();
	...
	{
		return ServerFinderScreen.instance == null
			|| ServerFinderScreen.instance
				.getState() == ServerFinderState.CANCELLED
			|| ServerFinderScreen.getSearchNumber() != searchNumber;
	}
	...
	public void onServerDone(WurstServerPinger pinger)
	{
		synchronized(portPingerLock)
		{
			...
			if(portPingers == currentIncrement / 10 * 18
				&& currentIncrement <= 1000 && successfulPortPingers > 0)
